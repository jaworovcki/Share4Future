        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSuccessfullEmailVarification = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSuccessfullAvailabilityVarification = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OfferingsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptedDeclinedTimestamp = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AcceptDeclineMessage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DoneTimestamp = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BorrowerRating = table.Column<int>(type: "int", nullable: true),
                    BorrowerRatingNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    LenderRating = table.Column<int>(type: "int", nullable: true),
                    LenderRatingNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DeviceRating = table.Column<int>(type: "int", nullable: true),
                    DeviceRatingNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sharings", x => x.Id);
                    table.CheckConstraint("UntilAfterFrom", "[Until] > [From]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("UntilAfterFrom1", "[Until] IS NULL\r\n                OR [Until] > [From]");
                    table.ForeignKey(
